...
export type AdSegment = {
  ...
  confidence: number;
  label: string;
  source: 'openai-ad-model' | 'codex-ad-model' | 'openai-transcript' | 'local-whisper-transcript' | 'public-transcript' | 'demo-rule-engine' | 'manual';
  reason?: string;
};
...
export type AnalysisResult = {
  episodeId: string;
  engine: 'openai-ad-model' | 'codex-ad-model' | 'openai-transcript' | 'local-whisper-transcript' | 'public-transcript' | 'unavailable';
